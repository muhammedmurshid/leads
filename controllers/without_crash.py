...
class LeadWithoutCrashExcelReportController(http.Controller):
    @http.route([
        '/lead_report_without_crash/excel_report/<model("lead.report"):report_id>',
    ], type='http', auth="user", csrf=False)
    def get_without_crash_excel_report(self, report_id=None, **args):
        ...
        report_lines = report_id.get_without_crash_report_lines()
