...
class LeadSourceCrashExcelReportController(http.Controller):
    @http.route([
        '/lead_report_source_crash/excel_report/<model("lead.report"):report_id>',
    ], type='http', auth="user", csrf=False)
    def get_crash_excel_report(self, report_id=None, **args):
        ...
        report_lines = report_id.get_crash_report_lines()
